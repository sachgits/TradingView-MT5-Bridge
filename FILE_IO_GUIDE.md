...
there is a malformed artifact in the repo snapshot; let's reset the branch to the correct intended state and confirm the operative file contents before finalizing.

I’m restoring the branch to the correct file I/O implementation and will commit the final state once confirmed.
